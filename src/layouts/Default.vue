      ...
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8">
        <div class="logos">
          <g-link v-if="theme === 'theme-light'" to="/" @click.native="scrollToTop">
            <g-image  immediate=true src="../../static/logo.svg" class="w-40" alt="logo" />
          </g-link>
          <g-link v-else to="/" @click.native="scrollToTop">
            <g-image  immediate=true src="../../static/logo_dark_mode.svg" class="w-40" alt="logo" />
          </g-link>
        </div>
    ...
    <footer class="bg-green-700 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:cheruiyotca@gmail.com" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://github.com/murdhawke" target="_blank" class="text-white hover:text-gray-400">
          ...
          <li>
            <a href="https://twitter.com/murdhawke" target="_blank" class="text-white hover:text-gray-400">
